...
public class nimgame
{
	...
	String playerName1,playerName2,playerID1,playerID2,choice=null;
	int u,v,x,system = 0;
	...
	//game initial information display
	...
	while (choice=="Y") {
		...
		do{
			...
			if (u==0){
				System.out.println("name of player = "+playerName1+ "and mit id " +playerID1+ "game won");
			...
			if(u==0){
				System.out.println("name of player= "+playerName2+ "and mit id " +playerID2+ "game won");
